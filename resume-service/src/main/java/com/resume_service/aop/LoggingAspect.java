package com.resume_service.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(* com.resume_service..controller..*(..))")
     ...
     */
    @Pointcut("execution(* com.resume_service..service..*(..))")
    public void serviceLayer() {
        // Pointcut definition
    }

    /**
     * Pointcut that matches all classes in the repository packages.
     */
    @Pointcut("execution(* com.resume_service..repository..*(..))")
