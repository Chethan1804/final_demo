...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(* com.AI_service..controller..*(..))")
     ...
     */
    @Pointcut("execution(* com.AI_service..service..*(..))")
     ...
     */
    @Pointcut("execution(* com.AI_service..repository..*(..))")
